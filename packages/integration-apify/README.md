...
Paid tools additionally require an active Agent Orchestrator run, a healthy shared rate limiter, scoped tenant credentials, and the integration to be enabled. Operational cost, privacy, actor-build update, canary, cleanup, and rollback procedures are documented in `docs/operations.md`.
